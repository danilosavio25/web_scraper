Wookieepedia:Review board membership nominations | Wookieepedia | Fandom
...
[Sign In](https://auth.fandom.com/signin?source=mw&redirect=https%3A%2F%2Fstarwars.fandom.com%2Fwiki%2FWookieepedia%3AReview_board_membership_nominations)

[Register](https://auth.fandom.com/register?source=mw&redirect=https%3A%2F%2Fstarwars.fandom.com%2Fwiki%2FWookieepedia%3AReview_board_membership_nominations)
...
in:
[Semi-protected pages](/wiki/Category:Semi-protected_pages "Category:Semi-protected pages"), [Wookieepedia peer review](/wiki/Category:Wookieepedia_peer_review "Category:Wookieepedia peer review")

# Wookieepedia:Review board membership nominations

[View source](/wiki/Wookieepedia:Review_board_membership_nominations?action=edit) 

* [History](/wiki/Wookieepedia:Review_board_membership_nominations?action=history)
* [Purge](/wiki/Wookieepedia:Review_board_membership_nominations?action=purge)
* [Talk (0)](/wiki/Wookieepedia_talk:Review_board_membership_nominations?action=edit&redlink=1)

[![This page is semi-protected.](https://static.wikia.nocookie.net/starwars/images/9/96/Protect-S.svg/revision/latest?cb=20240702171546)](/wiki/Wookieepedia:Protection_policy#Semi-protection "This page is semi-protected.")

[Shortcut](/wiki/Wookieepedia:Shortcut "Wookieepedia:Shortcut"):  
WP:RBMN

| Wookieepedia review boards |
| --- |
| [Site-logo](https://static.wikia.nocookie.net/starwars/images/e/e6/Site-logo.png/revision/latest?cb=20250801005026) |
| [Inquisitorius](/wiki/Wookieepedia:Inquisitorius "Wookieepedia:Inquisitorius") |
| [AgriCorps](/wiki/Wookieepedia:AgriCorps "Wookieepedia:AgriCorps") |
| [EduCorps](/wiki/Wookieepedia:EduCorps "Wookieepedia:EduCorps") |
| [Review board recruitment](/wiki/Wookieepedia:Review_board_recruitment "Wookieepedia:Review board recruitment") |
| **Membership nominations** and [removals](/wiki/Wookieepedia:Requests_for_removal_of_review_board_membership "Wookieepedia:Requests for removal of review board membership") |

This page is for **review board membership nominations**.

Voting ends fourteen days (336 hours) after the start of nomination, at which time, if the vote is affirmative, the nominee will be inducted into the review board. [Archival instructions may be found here](/wiki/Wookieepedia:Review_board_membership_nominations/instructions "Wookieepedia:Review board membership nominations/instructions").

To be nominated to join a review board you will generally need to have expressed interest on the [review board recruitment](/wiki/Wookieepedia:Review_board_recruitment "Wookieepedia:Review board recruitment") page, after which the current members of the relevant board will offer guidance on developing the skills needed to join it.

## Contents

* [1 Rules](#Rules)
* [2 EduCorps membership](#EduCorps_membership)
  + [2.1 Nominations](#Nominations)
* [3 AgriCorps membership](#AgriCorps_membership)
  + [3.1 Nominations](#Nominations_2)
* [4 Inquisitorius membership](#Inquisitorius_membership)
  + [4.1 Nominations](#Nominations_3)
...
* If not nominated by a member of the review board for which they are being nominated, the nominee must have been signed up on the recruitment page for at least one month prior to the nomination.
* Support votes must have a 2/3rds supermajority for the request to be accepted.
* At least ten eligible Wookieepedians must contribute a vote.
* Self-votes will not be counted in the vote totals.

## [EduCorps](/wiki/Wookieepedia:EduCorps "Wookieepedia:EduCorps") membership

To view past requests, see the [EC archive](/wiki/Wookieepedia:Review_board_membership_nominations/EC_archive "Wookieepedia:Review board membership nominations/EC archive").

### Nominations

## [AgriCorps](/wiki/Wookieepedia:AgriCorps "Wookieepedia:AgriCorps") membership

To view past requests, see the [AC archive](/wiki/Wookieepedia:Review_board_membership_nominations/AC_archive "Wookieepedia:Review board membership nominations/AC archive").

### Nominations

## [Inquisitorius](/wiki/Wookieepedia:Inquisitorius "Wookieepedia:Inquisitorius") membership

To view past requests, see the [Inq archive](/wiki/Wookieepedia:Review_board_membership_nominations/Inq_archive "Wookieepedia:Review board membership nominations/Inq archive").
...
* [Wookieepedia peer review](/wiki/Category:Wookieepedia_peer_review "Category:Wookieepedia peer review")
