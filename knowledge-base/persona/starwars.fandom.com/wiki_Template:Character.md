Template:Character | Wookieepedia | Fandom
...
[Sign In](https://auth.fandom.com/signin?source=mw&redirect=https%3A%2F%2Fstarwars.fandom.com%2Fwiki%2FTemplate%3ACharacter)

[Register](https://auth.fandom.com/register?source=mw&redirect=https%3A%2F%2Fstarwars.fandom.com%2Fwiki%2FTemplate%3ACharacter)
...
in:
[Fully protected pages](/wiki/Category:Fully_protected_pages "Category:Fully protected pages"), [Character infobox templates](/wiki/Category:Character_infobox_templates "Category:Character infobox templates")

# Character

Template page

[View source](/wiki/Template:Character?action=edit) 

* [History](/wiki/Template:Character?action=history)
* [Purge](/wiki/Template:Character?action=purge)
* [Talk (50)](/wiki/Template_talk:Character)
...
| Visit [Template:Character/doc](/wiki/Template:Character/doc "Template:Character/doc") to edit this documentation. ([How does this work?](/wiki/Template:Documentation "Template:Documentation")) |
...
* Per [Forum:CT:Partner Field CT - Part the Second](/wiki/Forum:CT:Partner_Field_CT_-_Part_the_Second "Forum:CT:Partner Field CT - Part the Second"), additions to the partners field should meet at least one of the criteria defined on **[Template:Character/doc/partners](/wiki/Template:Character/doc/partners "Template:Character/doc/partners")**.
...
* If applicable, a `|donor=` parameter may be added between `|pronouns=` and `|height=` to showcase individual(s) from which the article subject was cloned, **not** their biological or cultural parental figure. Example for [Luuke Skywalker](/wiki/Luuke_Skywalker "Luuke Skywalker"):

```
|donor=[[Luke Skywalker/Legends|Luke Skywalker]]
```

:   →See [Forum:CT:Clones and Infoboxes - Part One](/wiki/Forum:CT:Clones_and_Infoboxes_-_Part_One "Forum:CT:Clones and Infoboxes - Part One")
...
:   →See [Forum:CT:Merging the Pet infobox with Character](/wiki/Forum:CT:Merging_the_Pet_infobox_with_Character "Forum:CT:Merging the Pet infobox with Character")

* If applicable, an infobox gallery can be added, **pursuant to the requirements outlined in the [in-universe Layout Guide](/wiki/Wookieepedia:Layout_Guide/In-universe "Wookieepedia:Layout Guide/In-universe")**.
...
:   →See [Forum:CT:Infobox image galleries](/wiki/Forum:CT:Infobox_image_galleries "Forum:CT:Infobox image galleries")

### Example

[![Padmegreenscrshot](https://static.wikia.nocookie.net/starwars/images/b/b2/Padmegreenscrshot.jpg/revision/latest/scale-to-width-down/500?cb=20100423143631)](https://static.wikia.nocookie.net/starwars/images/b/b2/Padmegreenscrshot.jpg/revision/latest?cb=20100423143631 "Padmegreenscrshot")
...
[Naboo](/wiki/Naboo "Naboo")

### Born

[46 BBY](/wiki/46_BBY "46 BBY"), Naboo

### Died

[19 BBY](/wiki/19_BBY "19 BBY"), [Polis Massa](/wiki/Polis_Massa "Polis Massa") (2 [days](/wiki/Standard_day "Standard day") after [Empire Day](/wiki/Empire_Day "Empire Day"))

## Descriptive information

### Species

[Human](/wiki/Human "Human") ([Naboo](/wiki/Naboo_(people) "Naboo (people)"))

### Gender

[Female](/wiki/Gender "Gender")
...
1.65 [meters](/wiki/Meter "Meter") (5 [ft](/wiki/Foot "Foot") 5 in)

### Hair color

[Brown](/wiki/Color "Color")
...
* [Naberrie family](/wiki/Naberrie_family "Naberrie family")
* [Skywalker family](/wiki/Skywalker_family "Skywalker family") (through [marriage](/wiki/Marriage "Marriage"))

### Parent(s)

* [Jobal Naberrie](/wiki/Jobal_Naberrie "Jobal Naberrie")
* [Ruwee Naberrie](/wiki/Ruwee_Naberrie "Ruwee Naberrie")

### Sibling(s)

[Sola Naberrie](/wiki/Sola_Naberrie "Sola Naberrie")

### Children

* [Luke Skywalker](/wiki/Luke_Skywalker "Luke Skywalker")
* [Leia Skywalker Organa Solo](/wiki/Leia_Skywalker_Organa_Solo "Leia Skywalker Organa Solo")

## Chronological & political information

### Affiliation(s)

* [Refugee Relief Movement](/wiki/Refugee_Relief_Movement "Refugee Relief Movement")
* [Apprentice Legislature](/wiki/Apprentice_Legislature "Apprentice Legislature")
* [Legislative Youth Program](/wiki/Legislative_Youth_Program "Legislative Youth Program")
* [Royal House of Naboo](/wiki/Royal_House_of_Naboo "Royal House of Naboo")
* [Galactic Republic](/wiki/Galactic_Republic "Galactic Republic")
  + [Naboo delegation](/wiki/Naboo_delegation "Naboo delegation")
  + [Loyalist Committee](/wiki/Loyalist_Committee "Loyalist Committee")
  + [Delegation of 2,000](/wiki/Delegation_of_2,000 "Delegation of 2,000")

### Masters

[Mina Bonteri](/wiki/Mina_Bonteri "Mina Bonteri") (mentor)

[[Source]](https://starwars.fandom.com/wiki/Template:Character)

In other languages

* [français](https://starwars.fandom.com/fr/wiki/Mod%C3%A8le:Personnage "w:c:fr.starwars:Modèle:Personnage")
...
* [Character infobox templates](/wiki/Category:Character_infobox_templates "Category:Character infobox templates")
