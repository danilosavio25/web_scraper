Statistics | Wookieepedia | Fandom
...
[Sign In](https://auth.fandom.com/signin?source=mw&redirect=https%3A%2F%2Fstarwars.fandom.com%2Fwiki%2FSpecial%3AStatistics)

[Register](https://auth.fandom.com/register?source=mw&redirect=https%3A%2F%2Fstarwars.fandom.com%2Fwiki%2FSpecial%3AStatistics)
...
| Page statistics | |
| --- | --- |
| Content pages | 222,589 |
| [Pages](/wiki/Special:AllPages "Special:AllPages")  (All pages in the wiki, including talk pages, redirects, etc.) | 711,818 |
| [Uploaded files](/wiki/Special:MediaStatistics "Special:MediaStatistics") | 149,076 |
| Edit statistics | |
| Page edits since Wookieepedia was set up | 15,313,410 |
| Average edits per page | 21.51 |
| User statistics | |
| Registered users [(list of members)](/wiki/Special:ListUsers "Special:ListUsers") | 38,916,788 |
| Active users [(list of members)](/wiki/Special:ActiveUsers "Special:ActiveUsers")  (Users who have performed an action in the last 30 days) | 477 |
| [Bots](/wiki/Wookieepedia:Bots "Wookieepedia:Bots") [(list of members)](/wiki/Special:ListUsers?group=bot "Special:ListUsers") | 12 |
| [Administrators](/wiki/Wookieepedia:Administrators "Wookieepedia:Administrators") [(list of members)](/wiki/Special:ListUsers?group=sysop "Special:ListUsers") | 16 |
| [Bureaucrats](/wiki/Wookieepedia:Bureaucrats "Wookieepedia:Bureaucrats") [(list of members)](/wiki/Special:ListUsers?group=bureaucrat "Special:ListUsers") | 4 |
| Fandom Staff [(list of members)](/wiki/Special:ListUsers?group=staff "Special:ListUsers") | 0 |
| Fandom Utilities [(list of members)](/wiki/Special:ListUsers?group=util "Special:ListUsers") | 0 |
| Fandom Helpers [(list of members)](/wiki/Special:ListUsers?group=helper "Special:ListUsers") | 0 |
| [Spam Obliteration and Prevention](/wiki/Wookieepedia:Soap "Wookieepedia:Soap") [(list of members)](/wiki/Special:ListUsers?group=soap "Special:ListUsers") | 0 |
| Wiki Specialists [(list of members)](/wiki/Special:ListUsers?group=wiki-specialist "Special:ListUsers") | 0 |
| [Global Discussions Moderators](/wiki/Wookieepedia:Global-discussions-moderator "Wookieepedia:Global-discussions-moderator") [(list of members)](/wiki/Special:ListUsers?group=global-discussions-moderator "Special:ListUsers") | 0 |
| [Thread Moderators](/wiki/Wookieepedia:Threadmoderator "Wookieepedia:Threadmoderator") [(list of members)](/wiki/Special:ListUsers?group=threadmoderator "Special:ListUsers") | 3 |
| [Vanguards](/wiki/Wookieepedia:Vanguard "Wookieepedia:Vanguard") [(list of members)](/wiki/Special:ListUsers?group=vanguard "Special:ListUsers") | 0 |
| [Content Reviewers](/wiki/Wookieepedia:Content-reviewer "Wookieepedia:Content-reviewer") [(list of members)](/wiki/Special:ListUsers?group=content-reviewer "Special:ListUsers") | 0 |
| [Fandom Translators](https://community.fandom.com/wiki/Help:Internationalization "wikia:Help:Internationalization") [(list of members)](/wiki/Special:ListUsers?group=translator "Special:ListUsers") | 0 |
| Image Reviewers [(list of members)](/wiki/Special:ListUsers?group=imagereviewer "Special:ListUsers") | 0 |
| [Global Bots](/wiki/Wookieepedia:Bot-global "Wookieepedia:Bot-global") [(list of members)](/wiki/Special:ListUsers?group=bot-global "Special:ListUsers") | 0 |
| [Content Moderators](/wiki/Wookieepedia:Content-moderator "Wookieepedia:Content-moderator") [(list of members)](/wiki/Special:ListUsers?group=content-moderator "Special:ListUsers") | 0 |
| Edit Reviewers [(list of members)](/wiki/Special:ListUsers?group=global-edit-reviewer "Special:ListUsers") | 0 |
| [Wordpress Access Group](/wiki/Wookieepedia:Fandom-editor "Wookieepedia:Fandom-editor") [(list of members)](/wiki/Special:ListUsers?group=fandom-editor "Special:ListUsers") | 0 |
| Fandom Stars [(list of members)](/wiki/Special:ListUsers?group=fandom-star "Special:ListUsers") | 0 |
| [Request To Be Forgotten Admins](/wiki/Wookieepedia:Request-to-be-forgotten-admin "Wookieepedia:Request-to-be-forgotten-admin") [(list of members)](/wiki/Special:ListUsers?group=request-to-be-forgotten-admin "Special:ListUsers") | 0 |
| Content Volunteers [(list of members)](/wiki/Special:ListUsers?group=content-volunteer "Special:ListUsers") | 0 |
| [Rollback Group](/wiki/Wookieepedia:Rollback "Wookieepedia:Rollback") [(list of members)](/wiki/Special:ListUsers?group=rollback "Special:ListUsers") | 7 |
| Notifications Managers [(list of members)](/wiki/Special:ListUsers?group=notifications-cms-user "Special:ListUsers") | 0 |
| Volunteer Developers [(list of members)](/wiki/Special:ListUsers?group=voldev "Special:ListUsers") | 0 |
| Sensitive Tools Admins [(list of members)](/wiki/Special:ListUsers?group=sensitive-tool-access "Special:ListUsers") | 0 |
| Legal image reporting [(list of members)](/wiki/Special:ListUsers?group=legal-image-reporting "Special:ListUsers") | 0 |
| Quick Answers Editors [(list of members)](/wiki/Special:ListUsers?group=quick-answers-editor "Special:ListUsers") | 0 |
| Monetization Team [(list of members)](/wiki/Special:ListUsers?group=monetization-team "Special:ListUsers") | 0 |
| Monetization Reviewer [(list of members)](/wiki/Special:ListUsers?group=monetization-reviewer "Special:ListUsers") | 0 |
| CheckUser Admins [(list of members)](/wiki/Special:ListUsers?group=checkuser "Special:ListUsers") | 3 |
| Temporary account IP viewers [(list of members)](/wiki/Special:ListUsers?group=checkuser-temporary-account-viewer "Special:ListUsers") | 0 |
| [Restricted-Login Exempt Group](/wiki/Wookieepedia:Restricted-login-exempt "Wookieepedia:Restricted-login-exempt") [(list of members)](/wiki/Special:ListUsers?group=restricted-login-exempt "Special:ListUsers") | 0 |
| [blogger](/wiki/Wookieepedia:Blogger "Wookieepedia:Blogger") [(list of members)](/wiki/Special:ListUsers?group=blogger "Special:ListUsers") | 6 |
...
**Current pages** *(This version is usually best for bot use):* [2025-12-20 20:12:26](https://s3.amazonaws.com/wikia_xml_dumps/s/st/starwars_pages_current.xml.7z)

**Current pages and history** *(Warning: this file may be very large):* [2025-12-20 20:12:26](https://s3.amazonaws.com/wikia_xml_dumps/s/st/starwars_pages_full.xml.7z)

Please [see](https://community.fandom.com/wiki/Help:Database_download) for more info
