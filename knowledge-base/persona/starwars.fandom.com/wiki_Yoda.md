View source for Yoda | Wookieepedia | Fandom
...
# View source for Yoda

[Back to page](/wiki/Yoda "Yoda") | ← [Yoda](/wiki/Yoda "Yoda")
...
|  |  |
| --- | --- |
| [Padlockicon2](https://static.wikia.nocookie.net/starwars/images/5/5e/Padlockicon2.png/revision/latest?cb=20081224175802) | **This page is currently [semi-protected](/wiki/Wookieepedia:Protection_policy "Wookieepedia:Protection policy") so that only registered users can modify it.**  While most Wookieepedia pages are editable by anyone, page protection is sometimes necessary to prevent vandalism and other forms of disruption. For more information, refer to the [Protection policy](/wiki/Wookieepedia:Protection_policy "Wookieepedia:Protection policy").  * **[Create an account](/wiki/Special:UserSignup "Special:UserSignup")** and wait **four days** for your account to reach "autoconfirmed" status, at which point you can edit this page. * **[Post on the talk page](/wiki/Talk:Yoda "Talk:Yoda")** if you find something that needs to be changed in the meantime. |
