...
# The Python Tutorial[Â¶](#the-python-tutorial "Link to this heading")
...
* [6. Modules](modules.html)
  + [6.1. More on Modules](modules.html#more-on-modules)
    ...
    - [6.1.3. âCompiledâ Python files](modules.html#compiled-python-files)
...
* [11. Brief Tour of the Standard Library â Part II](stdlib2.html)
